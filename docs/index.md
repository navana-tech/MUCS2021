...
<button class="collapsible"><img style="height:auto; width:auto;padding:5px;"  src="./assets/img/persons/Anurag_Dwarakanath.PNG">Anurag Dwarakanath (amazon) - Spoken Language Understanding for the Indic Region</button>
<div class="content">
